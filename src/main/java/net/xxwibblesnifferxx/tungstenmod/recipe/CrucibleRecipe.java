...
public class CrucibleRecipe implements Recipe<SimpleInventory>
{
    private final Identifier id;
    private final ItemStack output;
    private final DefaultedList<Ingredient> recipeItems;

    public CrucibleRecipe(Identifier id, ItemStack output, DefaultedList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
    ...
    public static class Serializer implements RecipeSerializer<CrucibleRecipe>
    {
        ...
        public static final String ID = "crucible";
        // this is the name given in the json file DON'T FORGET THIS DUMBASS
